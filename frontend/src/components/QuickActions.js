            ...
            <CardContent sx={{ p: 3 }}>
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                        ...
                        >
                            {t('quick_actions_view_all_children')}
                        </Button>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <Button
                    ...
                    <Grid item xs={12} sm={6}>
                        ...
                        >
                            {t('quick_actions_view_notices', { count: noticesList ? noticesList.length : 0 })}
                        </Button>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <Button
                        ...
                        >
                            {t('quick_actions_submit_complaint')}
                        </Button>
                    </Grid>
                </Grid>
            </CardContent>
