  ...
  return (
    <>
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
          ...
          <Grid item xs={12}>
            <Paper sx={{ p: 3, width: "100%", maxWidth: 1200, boxShadow: 2, display: 'flex', flexDirection: 'column' }}>
              ...
              {assignmentsLoading ? (
                ...
                <TableContainer component={Paper} sx={{ mt: 2, maxHeight: 600, overflowY: 'auto' }}>
                  <Table stickyHeader>
                    <TableHead>
                      <TableRow>
                        <TableCell sx={{ fontWeight: 'bold', width: '25%' }}>Title</TableCell>
                        <TableCell sx={{ fontWeight: 'bold', width: '20%' }}>Due Date</TableCell>
                        <TableCell sx={{ fontWeight: 'bold', width: '15%', textAlign: 'center' }}>Status</TableCell>
                        <TableCell sx={{ fontWeight: 'bold', width: '20%', textAlign: 'center' }}>Time Left</TableCell>
                        <TableCell sx={{ fontWeight: 'bold', width: '20%', textAlign: 'center' }}>Actions</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {assignments.map((assignment) => {
                        ...
                        return (
                          <TableRow key={assignment._id} hover>
                            ...
                            <TableCell sx={{ color: 'text.secondary' }}>{dueDate}</TableCell>
                  ...
                  {/* Submission form */}
                  {/* Remove this block to avoid duplicate submission form */}
                  {/* {assignments.map((assignment) => (
        ...
        {console.log('Rendering submission form, editingSubmission:', editingSubmission)}
        {editingSubmission ? (
          <>
            <Button
              variant="outlined"
