...
router.put("/Teacher/BulkAssignments", require("../controllers/teacher-controller.js").updateTeacherBulkAssignments)
router.put("/Teacher/Attendance", require("../controllers/teacher-controller.js").updateTeacherAttendance)
